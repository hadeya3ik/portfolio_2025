...
function page() {
  return (
    <div className="p-4 min-h-screen l items-center bg-primary text-primary-foreground pb-36 pt-36">
          ...
          <div className='max-w-xl text-xs flex flex-col justify-center items-center w-full gap-8 pt-8'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='pb-4'>
                ...
                Similar to our Instagram, the updated design features vibrant gradients as the key visual element aligning with SMILES positive values.
              </p>
